  ...
  return (
    <div>
      ...
      <div className="x-6 md:px-12 lg:px-24">
        {/* Services Heading */}
        <div className="text-2xl uppercase font-bold mb-12 text-[#1B4A7B] text-center mt-16">
          Services
        </div>
        ...
        <div className="mt-16">
          ...
          <div className="flex flex-col gap-8 items-center mb-16">
            {/* Tip Box 1 */}
            <div className="flex items-center bg-[#F1FBFD] shadow-lg p-6 rounded-lg w-full ">
              <img
                src="dog-walking.png"
                alt="Dog Walking"
