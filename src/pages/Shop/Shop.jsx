        ...
        <div>
            ...
            <div className="relative flex flex-col md:flex-row-reverse justify-between items-center gap-8 p-10 min-h-[50vh] ">
                ...
                <div className="relative md:w-3/4  md:text-left space-y-7 px-4">
                    ...
                    {/* <button
                        className="btn bg-[#1B4A7B] px-8  py-3 font-semibold text-white rounded-full hover:bg-[#163c66] transition drop-shadow-lg">
                        Shop Now
                    </button> */}
                </div>
            </div>
            ...
            <div className="p-10 mt-12">
                ...
                <div className="flex flex-wrap justify-center md:justify-start gap-4 mb-8">
                    {["all", "dog-foods", "cat-foods", "toys"].map((category) => (
                        <button 
                            key={category}
                            onClick={() => filterItems(category)}
                            className={`px-6 py-2 rounded-full font-semibold ${selectedCategory === category ? "bg-blue-600 text-white" : "bg-gray-200 text-black"}`}>
