...
const Navbar = () => {
  ...
  const navItems = (
    <>
      ...
      <li>
        <a href="aboutus" className=" hover:text-gray-300">AboutUs</a>
      </li>
    </>
  );
    ...
    >
      <div
        className={`navbar xl:px-24 ${
          isSticky
            ? "shadow-md bg-[#1B4A7B] transition-all duration-300 ease-in-out"
            : ""
        }`}
      >
        ...
        <div className="navbar-end ">
          ...
          {/* login button */}
          {
            <button
              ...
              className="btn flex items-center gap-2 rounded-full px-6 bg-[#58B5C6]"
            >
              SignIn
            </button>
          }
